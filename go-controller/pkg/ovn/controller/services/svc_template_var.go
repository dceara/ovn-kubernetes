...
func listSvcTemplates(nbClient libovsdbclient.Client) (templatesByName TemplateMap, err error) {
	...
	templatesList, err := libovsdbops.ListTemplates(nbClient)
	if err != nil {
		return
	}
...
func svcCreateTemplateVarOps(nbClient libovsdbclient.Client,
	...
	forEachNBTemplateInMaps(templateVars, func(nbTemplate *nbdb.ChassisTemplateVar) bool {
		ops, err = libovsdbops.CreateChassisTemplateVarOps(nbClient, ops, nbTemplate)
		return err == nil
	})
	if err != nil {
		return nil, err
...
func svcDeleteTemplateVarOps(nbClient libovsdbclient.Client,
	...
	forEachNBTemplateInMaps(templateVars, func(nbTemplate *nbdb.ChassisTemplateVar) bool {
		ops, err = libovsdbops.DeleteChassisTemplateVarOps(nbClient, ops, nbTemplate)
		return err == nil
	})
	if err != nil {
		return nil, err
