...
func (r *repair) runBeforeSync() {
	...
	// Find all templates.
	allTemplates, err := libovsdbops.ListTemplates(r.nbClient)
	if err != nil {
	...
	if err := libovsdbops.DeleteChassisTemplateVarByName(r.nbClient, staleTemplateNames.UnsortedList()); err != nil {
